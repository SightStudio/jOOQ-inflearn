...
public class JooqSubqueryTest {
    ...
    void 스칼라_서브쿼리_예제() {
        ...
        List<FilmPriceSummary> priceSummaryList = filmRepository.findFilmPriceSummaryByFilmTitleLike(filmTitle);
    ...
    void from절_서브쿼리_인라인뷰_예제() {
        ...
        List<FilmRentalSummary> rentalSummaryList = filmRepository.findFilmRentalSummaryByFilmTitleLike(filmTitle);
        Assertions.assertThat(rentalSummaryList).isNotEmpty();
    }
